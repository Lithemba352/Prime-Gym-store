...
const MPContractAddress = "0x89A28A7598C13E156Ade2B69DCAD10D68e17D744";
  ...
  return `
    <div class="card mb-4 shadow-lg border-0 rounded-lg overflow-hidden" style="background-color: #f0f0f0;">
      <div style="position: relative;">
        <img class="card-img-top" src="${_product.image}" alt="Supplement Image" style="object-fit: cover; height: 200px;">
      </div>
